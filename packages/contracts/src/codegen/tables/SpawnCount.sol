...
library SpawnCount {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "GardenOfEden", name: "SpawnCount", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746247617264656e4f664564656e0000537061776e436f756e74000000000000);
   ...
   * @notice Get count.
   */
  function getCount(address player) internal view returns (uint32 count) {
   ...
   * @notice Get count.
   */
  function _getCount(address player) internal view returns (uint32 count) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Get count.
   */
  function get(address player) internal view returns (uint32 count) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Get count.
   */
  function _get(address player) internal view returns (uint32 count) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set count.
   */
  function setCount(address player, uint32 count) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set count.
   */
  function _setCount(address player, uint32 count) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set count.
   */
  function set(address player, uint32 count) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set count.
   */
  function _set(address player, uint32 count) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
