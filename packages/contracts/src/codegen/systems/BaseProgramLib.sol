...
// equivalent to WorldResourceIdLib.encode({ typeId: RESOURCE_SYSTEM, namespace: "GardenOfEden", name: "BaseProgram" }))
BaseProgramType constant baseProgram = BaseProgramType.wrap(
  0x737947617264656e4f664564656e00004261736550726f6772616d0000000000
);
